...
public class StringMethods {
    public static void main(String[] args) {
        ...
        // we will have spaces in here because String class is immutable

        // if you want to get index of char or string we need to is a indexOf() method
               // indexes0123456
        String number = "0123456";
        // get the index of 3
        System.out.println(number.indexOf('3')); // index of 3 is three
        // get the index of 56
        // indexof(string seçince, '56'nın indeks numarası 5 oluyor bütün gibi)
        ...
        // ikisi yanyana değil,küçük sayının -1 dönüyor.

        String sentence = "Java is a programming language";
        System.out.println(sentence.indexOf(" programming "));
                          //01234567891011
        String sentence1 = "Java is Java";//önemli bir örnek bizim için!
